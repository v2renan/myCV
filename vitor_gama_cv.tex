...
\begin{center}
    ...
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/vitor-gama-6a8503136/}{\color{blue}LinkedIn}
    $|$
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {M.Sc., Chemical Engineering;}{Sep 2018 \textbf{--} April 2021}{\textbf{Academic Coefficient: 9.14/10.00}}{}
...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (M.Sc.)}{Sep 2018 \textbf{--} April 2021}
        \resumeItemListStart
...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Federal University of Campina Grande}{Campina Grande, Paraiba, Brazil}
      {Graduate Research Assistant (M.Sc.) and Developer}{Sep 2019 \textbf{--} Mar 2021}
        \resumeItemListStart
            ...
            \resumeItem{Worked on developing mock-ups for the process control user interface of the tool}
            \resumeItem{Troubleshooting and code analysis}
        \resumeItemListEnd
