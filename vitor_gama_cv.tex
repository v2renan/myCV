...
\section{Awards \& Achievements}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Jack and Marietta Mullenger Fellowship (2024)} \\ \vspace{3pt}

        \textbf{Recruitment Fellowship (2021)} \\ \vspace{3pt}
...
{\item}
\nocite{*}
\printbibliography[env = bibliography, title= Selected Research Publications - Complete list on my {\href{https://scholar.google.com/citations?user=6HpSBZUAAAAJ&hl=en}{\color{blue}Google Scholar.}} ]
